...
function initMap() {
        ...
        { 
          featureType: 'water',
          stylers: [{color: '#76bac1'}]
        },
        {
              featureType: 'water',
              elementType: 'labels.text.fill',
              stylers: [{color: '#8f78db'}]
            },
            {
              featureType: 'water',
            ...
            },
            {
              ...
              stylers: [{color: '#f4cca8'}]
            },
            {
               featureType: 'road.highway.controlled_access',
               elementType: 'geometry',
               stylers: [{color: '#e2cab5'}]
            },
        {
          featureType: 'road.local',
               elementType: 'labels.text.fill',
               stylers: [{color: '#f7a34a'}]
            },
            {
              featureType: 'road',
              elementType: 'geometry.stroke',
              stylers: [{color: '#bc955e'}]
            },
            {
              featureType: 'road',
              elementType: 'labels.text.fill',
              stylers: [{color: '#c4731d'}]
            },
        {
              featureType: 'poi',
              elementType: 'labels.text.fill',
              stylers: [{color: '#994318'}]
            },
        {
              featureType: 'administrative.locality',
              elementType: 'labels.text.fill',
              stylers: [{color: '#961803'}]
            },

            {
                featureType: 'poi.park',
                elementType: 'geometry.fill',
                stylers: [{color: '#7dc471'}]
            }
      ];
...
var ViewModel = function() {
    ...
    //Opens infowindow on the marker and animates the marker
